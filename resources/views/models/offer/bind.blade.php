        ...
        <div class="col-md-12 col-sm-12">
            <div class="card shadow-sm">
                <div class="card-header">
                    <h4 class="card-title">{{$offer->offer}}</h4>
        ...
        <div class="col-md-12 col-sm-12">
            <div class="card shadow-sm">
                <div class="card-content collapse show">
                    <div class="card-body">
                        <!-- start: form -->
                        <form method="POST" action="{{Route('offer.set', $offer->id)}}">
                            @csrf
                                        ...
                                        <div class="card text-center">
                                            <div class="card-content">
                                                <div class="card-body">
                                                    ...
                                                    <p class="text-left">
                                                        @if(isset($service->stock->stock_quantity))
                                                            {{$service->service}} | <span>Existencias: {{$service->stock->stock_quantity}}</span>
                                                        @else
                                                            {{$service->service}} | <span>Sin existencias</span>
                                                        @endif
                                                    </p>
